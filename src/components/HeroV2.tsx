            ...
            <motion.figure variants={fadeInRight} className="relative">
              ...
              >
                <img 
                  ...
                  alt="Tuggi em funcionamento no painel do carro, narrando histórias durante o trajeto"
      ...
      >
        <div className={layout.container.base}>
          ...
          >
            ...
            <div className="hidden md:block absolute top-36 left-1/2 transform -translate-x-1/2 w-2/3 h-0.5 bg-gradient-to-r from-tuggi-primary/30 via-tuggi-primary/60 to-tuggi-primary/30 rounded-full"></div>
