...
export const betaDriversContent: Record<'PT' | 'IT' | 'EN' | 'ES' | 'FR' | 'DE', BetaDriversContent> = {
  PT: {
    hero: {
      ...
      title: 'Transforme suas corridas e aumente seus ganhos como Motorista Embaixador.',
  ...
  IT: {
    hero: {
      ...
      title: 'Trasforma le tue corse e aumenta i tuoi guadagni come Autista Ambasciatore.',
    ...
    betaForm: {
      ...
      form: {
        ...
        submitButton: 'Diventa Autista Ambasciatore',
  ...
  EN: {
    hero: {
      ...
      title: 'Turn Miles Into Memories and Boost Your Tips as a Driver Ambassador.',
    ...
    betaForm: {
      ...
      form: {
        ...
        submitButton: 'Become a Driver Ambassador',
  ...
  ES: {
    hero: {
      ...
      title: 'Transforma tus Viajes y Aumenta tus Ingresos como Conductor Embajador.',
    ...
    betaForm: {
      ...
      form: {
        ...
        submitButton: 'Ser Conductor Embajador',
        submittingButton: 'Enviando...',
      },
      successState: {
        title: '¡Gracias!',
  ...
  FR: {
    hero: {
      ...
      title: 'Transformez vos courses et augmentez vos pourboires en tant que Chauffeur Ambassadeur.',
    ...
    betaForm: {
      ...
      form: {
        ...
        submitButton: 'Devenir Chauffeur Ambassadeur',
  ...
  DE: {
    hero: {
      ...
      title: 'Werde Fahrer-Botschafter: Verwandle Fahrten in Erlebnisse und maximiere dein Trinkgeld.',
    ...
    betaForm: {
      ...
      form: {
        ...
        submitButton: 'Werde Fahrer-Botschafter',
